  ...
  <div class="row">
    ...
    <div class="span9">
    	<div class="pull-right">
	      <a href="form.htm" class="btn">添加特效页面</a>
      	</div>
      <h4 class="header">特效页面列表</h4>
      <div id="d3" style="width: 100%; margin-top: -30px"></div><br />
      <div>
       		<table class="table table-bordered table-hover" id="list">
       			<thead>
       				<tr>
       					<th>标题</th><th>链接地址</th><th>添加时间</th><th width="60">操作</th>
       				</tr>
       			</thead>
       			<tbody>
       				...
       				<tr data-id="${item.id}">
       					<td>${item.name}</td>
       					<td>${basePath}/weixin/application/site/custom/page.htm?id=${item.id}</td>
